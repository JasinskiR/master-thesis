...
\kvpl{współbieżność, równoległość, Rust, C++, ARM, x86\_64} % INFO: s�owa kluczowe po polsku
\kven{concurrency, parallelism, Rust, C++, ARM, x86\_64} % INFO: s�owa kluczowe po angielsku
...
% Add a blank page after abstract
\newpage
\thispagestyle{empty}
\mbox{}
\newpage

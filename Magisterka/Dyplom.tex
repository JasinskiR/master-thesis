...
\kvpl{współbieżność i równoległość, Rust i C++, ARM i x86\_64} % INFO: s�owa kluczowe po polsku
\kven{concurrency and parallelism, Rust and C++, ARM and x86\_64} % INFO: s�owa kluczowe po angielsku

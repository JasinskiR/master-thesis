...
\begin{itemize}
    \item W klasie A \texttt{new\_omp} wykazuje najwyższą liczbę page faults (13), zaś \texttt{rust} nie generuje żadnych błędów.
    \item W klasie B najwięcej błędów generuje \texttt{tbb} (12), podczas gdy \texttt{rust} ponownie nie wykazuje żadnych.
    \item W klasach S i W \texttt{rust} również nie generuje page faults, a inne wersje wykazują umiarkowane wartości (7-10).

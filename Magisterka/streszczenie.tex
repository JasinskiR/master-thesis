...
\begin{abstract}
Praca jest poświęcona porównaniu mechanizmów programowania współbieżnego i równoległego w językach Rust i C++. Pierwsza część obejmuje teoretyczne podstawy oraz przegląd literatury, identyfikując luki badawcze w porównaniach tych języków na różnych architekturach sprzętowych.

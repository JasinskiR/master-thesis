...
W literaturze dominują badania porównawcze bezpieczeństwa, wydajności oraz zarządzania pamięcią w językach Rust i C++ \cite{PPL1_1} - dodatkowe opisane w podrozdziałach \ref{Bezpieczeństwo} oraz \ref{CzasWykonania}. W kontekście współbieżności i równoległości brakuje systematycznych analiz porównawczych.
...
Dostępność bibliotek do programowania współbieżnego i równoległego w językach Rust i C++ jest na podobnym poziomie, choć Rust oferuje bardziej bezpieczne i wygodne narzędzia do zarządzania współbieżnością.
